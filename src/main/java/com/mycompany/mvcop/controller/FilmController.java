...
import com.mycompany.mvcop.service.FilmService;
...
public class FilmController {
    ...
    public ModelAndView editFilm(@ModelAttribute("film") Film film) {
        ...
        if (filmService.checkTitle(film.getTitle()) || filmService.getById(film.getId()).getTitle().equals(film.getTitle())) {
            ...
            modelAndView.addObject("message", "part with title \"" + film.getTitle() + "\" already exists");
            modelAndView.setViewName("redirect:/edit/list" + +film.getId());
        }
        return modelAndView;
    }
    ...
    @RequestMapping(value = {"deleteByCheck"})
    public String deleteUserByCheck(@RequestParam("fid") Integer[] id) {
        filmService.deleteByCheck(id);
